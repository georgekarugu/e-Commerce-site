...
function Navbar() {
  ...
  return (
    <nav className="bg-blue-700 h-20 shadow-md p-7 flex items-center justify-between">
      <div></div>
      ...
      <Link to="/categories" className="flex text-2xl font-bold items-center gap-2   relative text-white  transition duration-300 
                       before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-0.5 before:bg-white 
                       before:transition-all before:duration-300 hover:text-gray-300 
                       hover:before:w-full">Categories</Link>
...
<div className="relative w-72">
  ...
  >
    <Search size={28} />
      ...
      <Link to="/account" className="flex text-2xl font-bold items-center gap-2   relative text-white  transition duration-300 
                       before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-0.5 before:bg-white 
                       before:transition-all before:duration-300 hover:text-gray-300 
                       hover:before:w-full">
                        <User size={30}/>Account</Link>
